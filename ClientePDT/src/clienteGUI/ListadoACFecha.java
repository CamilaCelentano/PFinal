...
public class ListadoACFecha {
	...
	private void initialize() {
		...
		frmMenuInicial.setTitle("Actividad de campo por Fecha");
		...
		btnFiltrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (dateChooserIni.getDate() != null && dateChooserFin.getDate() != null) {
					...
					lblMsj.setText("Debe ingresar ambas fechas.");
				}

			}
		});
		btnFiltrar.setBounds(306, 87, 150, 23);
		...
		btnExportar.setBounds(476, 87, 150, 23);
