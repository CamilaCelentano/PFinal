...
public class ListadoACEstacion {
	...
	private void initialize() {
		...
		frmMenuInicial.setTitle("Actividad de campo por Estacion de Muestreo");
		...
		cbRol.setModel(new DefaultComboBoxModel(new String[] { "Todos", "Comun", "Experto", "Administrador" }));
		...
		mostrar(filtroEstacion(acBean.obtenerTodos(), (EstacionMuestreo) cbEst.getSelectedItem()));
	}
